...
public class FlightDao {
    ...
    enum FlightSQL {
        GET_ALL("SELECT Flight.id, P1.id, P1.code, P1.name, P2.id, P2.code, P2.name, Line.id, Line.code, Line.name, Flight.price FROM Flight JOIN Airport AS P1 on P1.id = Flight.from_airport_id JOIN Airport AS P2 on P2.id = Flight.to_airport_id JOIN Airline Line on Line.id = Flight.airline_id;"),
